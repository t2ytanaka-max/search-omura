            ...
            <div className="bg-gray-900/30 p-6 rounded-2xl border border-gray-850 space-y-4">
              ...
              <ul className="list-decimal pl-4.5 text-xs text-gray-400 space-y-3 leading-relaxed font-medium">
                ...
                <li>
                  ...
                  団員から届く極軽量CSV（ID、所属、ステータス、緯度経度、タイムスタンプ、メッセージ）の生ログを監視できます。地図を広く使いたい場合は、履歴ウィンドウの右上「∨ ∧」ボタンで生ログウィンドウを最小化（折りたたみ）してください。**なお、生ログの一括削除（ゴミ箱アイコン）を実行しても、安全上の最重要共有情報である「危険箇所(紫ピン)」だけは保護され、地図上に残り続けます。**
                </li>
              </ul>
            </div>
          </div>
