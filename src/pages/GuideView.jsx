          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900/30 p-6 rounded-2xl border border-gray-850 space-y-4">
              ...
              <ul className="list-decimal pl-4.5 text-xs text-gray-400 space-y-3 leading-relaxed font-medium">
                ...
                <li>
                  <strong className="text-white block mb-0.5">② 捜索の開始 (15分毎自動連絡)</strong>
                  「捜索開始 (15分毎自動連絡)」ボタンをタップします。タップ後、ボタンが青く「捜索中」と点滅を始めます。この間、電波の有無に関わらず、15分毎に自動でスマートフォンの現在地を本部に自動送信し続けます。
                </li>
                <li>
                ...
                <li>
                  ...
                  無事に捜索が完了し、下山準備に移る際は「捜索終了」ボタンをタップします。これによりボタンの点滅が消え、15分ごとの定期位置送信処理が安全に停止します。
                </li>
                <li>
        ...
        <section className="bg-gray-900/40 p-6 rounded-2xl border border-gray-850 space-y-5 shadow-lg">
          ...
          <ul className="list-disc pl-5 text-xs text-gray-400 space-y-3.5 leading-relaxed font-medium">
            <li>
              ...
              団員のスマートフォンで自動定期連絡を確実に動作させるために、位置情報のアクセス許可を必ず<strong className="text-rescue-500 font-bold">「常に許可」</strong>または「アプリの使用中のみ許可」に設定してください。また、バックグラウンドでのGPS取得を維持するため、捜索中はブラウザを完全に閉じず、バックグラウンドで起動したままにしておいてください。
            </li>
            <li>
              <strong className="text-white">圏外エリアでの挙動について：</strong>
              電波の届かない山岳部では、送信ボタンや自動定期連絡のデータは「未送信キュー」としてスマートフォン内部（IndexedDB）に一時保存されます。これは不具合ではなく仕様です。電波が回復（一瞬でも圏内に入った際）した段階で、内部の再送システムが順番に自動アップロードを行います。
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">電池消費の考慮について：</strong>
              GPSとリアルタイム通信を連続して行うため、バッテリーの消費が通常より早くなります。活動の際は予備のモバイルバッテリーを必ず携行してください。
            </li>
          </ul>
        </section>
